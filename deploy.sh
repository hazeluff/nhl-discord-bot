...
COMMANDS="cd /nhlbot && \
sudo /bin/mv ~/nhlbot-$1-jar-with-dependencies.jar /nhlbot/builds/nhlbot-$1.jar && \
sudo /bin/systemctl stop nhlbot && \
sudo ln -sfn nhlbot-$1.jar builds/nhlbot && \
sudo /bin/systemctl start nhlbot"
