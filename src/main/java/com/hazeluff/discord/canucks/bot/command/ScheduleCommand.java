...
public class ScheduleCommand extends Command {
	...
	static final Consumer<MessageCreateSpec> HELP_MESSAGE = spec -> spec
			.setContent("Get the game schedule any of the following teams by typing `@CanucksBot schedule [team]`, "
					+ "where [team] is the one of the three letter codes for your team below: "
					+ getTeamsListBlock());

	public ScheduleCommand(CanucksBot canucksBot) {
		super(canucksBot);
	}
	...
	Consumer<MessageCreateSpec> getScheduleMessage(Team team) {
		...
		GameScheduler gameScheduler = canucksBot.getGameScheduler();
