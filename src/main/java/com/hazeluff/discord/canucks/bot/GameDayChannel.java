...
import com.hazeluff.discord.canucks.nhl.custommessages.CanucksCustomMessages;
...
public class GameDayChannel extends Thread implements IEventProcessor {
	...
	GameDayChannel(CanucksBot canucksBot, GameTracker gameTracker, Game game, List<GameEvent> events, Guild guild,
			TextChannel channel) {
	...
	GameDayChannel(CanucksBot canucksBot, Game game, Guild guild) {
		this(canucksBot, null, game, game.getEvents(), guild, null);
	}

	GameDayChannel(CanucksBot canucksBot, GameTracker gameTracker, Guild guild) {
		this(canucksBot, gameTracker, gameTracker.getGame(), gameTracker.getGame().getEvents(), guild, null);
	}

	public static GameDayChannel get(CanucksBot canucksBot, GameTracker gameTracker, Guild guild) {
		GameDayChannel gameDayChannel = new GameDayChannel(canucksBot, gameTracker, guild);
	...
	/**
	 * Gets the message that CanucksBot will respond with when queried about this game
	 * 
	 * @param game
	...
	/**
	 * Gets the message that CanucksBot will respond with when queried about the score
	 * of the game
	 * 
