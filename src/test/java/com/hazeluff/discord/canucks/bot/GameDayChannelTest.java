...
public class GameDayChannelTest {
	...
	public void before() {
		...
		gameDayChannel = new GameDayChannel(mockCanucksBot, mockGameTracker, mockGame, events, mockGuild, mockChannel);
	...
	public void updateMessagesShouldSendMessagesForNewNewEvents() {
		...
		gameDayChannel = spy(new GameDayChannel(mockCanucksBot, mockGameTracker, mockGame, events, mockGuild, null));
